...
occ_search <- function(taxonKey = NULL,
                       ...
                       nucleotideSequence.nucleotideSequenceID = NULL,
                       nucleotideSequence.targetGene = NULL,
                       nucleotideSequence.sequence = NULL,
                       nucleotideSequence.sequenceLength = NULL,
                       nucleotideSequence.gcContent = NULL,
                       nucleotideSequence.nonIupacFraction = NULL,
                       nucleotideSequence.nonACGTNFraction = NULL,
                       nucleotideSequence.nFraction = NULL,
                       nucleotideSequence.nRunsCapped = NULL,
                       nucleotideSequence.naturalLanguageDetected = NULL,
                       nucleotideSequence.endsTrimmed = NULL,
                       nucleotideSequence.gapsOrWhitespaceRemoved = NULL,
                       nucleotideSequence.invalid = NULL,
                       isSequenced = NULL,
                       startDayOfYear = NULL,
                       endDayOfYear = NULL,
                       checklistKey = NULL,
  ...
  .get_occ_search <- function(x=NULL, itervar=NULL, curlopts = list()) {
    ...
    args <- c(
      ...
      convmany(nucleotideSequence.nucleotideSequenceID),
      convmany(nucleotideSequence.targetGene),
      convmany(nucleotideSequence.sequence),
      convmany(nucleotideSequence.sequenceLength),
      convmany(nucleotideSequence.gcContent),
      convmany(nucleotideSequence.nonIupacFraction),
      convmany(nucleotideSequence.nonACGTNFraction),
      convmany(nucleotideSequence.nFraction),
      convmany(nucleotideSequence.nRunsCapped),
      convmany(nucleotideSequence.naturalLanguageDetected),
      convmany(nucleotideSequence.endsTrimmed),
      convmany(nucleotideSequence.gapsOrWhitespaceRemoved),
      convmany(nucleotideSequence.invalid),
  ...
  params <- list(
    ...
    nucleotideSequence.nucleotideSequenceID=nucleotideSequence.nucleotideSequenceID,
    nucleotideSequence.targetGene=nucleotideSequence.targetGene,
    nucleotideSequence.sequence=nucleotideSequence.sequence,
    nucleotideSequence.sequenceLength=nucleotideSequence.sequenceLength,
    nucleotideSequence.gcContent=nucleotideSequence.gcContent,
    nucleotideSequence.nonIupacFraction=nucleotideSequence.nonIupacFraction,
    nucleotideSequence.nonACGTNFraction=nucleotideSequence.nonACGTNFraction,
    nucleotideSequence.nFraction=nucleotideSequence.nFraction,
    nucleotideSequence.nRunsCapped=nucleotideSequence.nRunsCapped,
    nucleotideSequence.naturalLanguageDetected=nucleotideSequence.naturalLanguageDetected,
    nucleotideSequence.endsTrimmed=nucleotideSequence.endsTrimmed,
    nucleotideSequence.gapsOrWhitespaceRemoved=nucleotideSequence.gapsOrWhitespaceRemoved,
    nucleotideSequence.invalid=nucleotideSequence.invalid,
    isSequenced=isSequenced,
