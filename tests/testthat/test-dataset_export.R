...
test_that("dataset_export works as expected", {
  ...
  expect_equal(names(h)[1], "dataset_key")
  expect_is(h,"tbl_df")
  ...
  expect_equal(names(hh)[1], "dataset_key")
  expect_is(hh,"tbl_df")
  ...
  expect_equal(names(d)[1], "dataset_key")
  expect_is(d,"tbl_df")
  ...
  expect_equal(names(dd)[1], "dataset_key")
  expect_is(dd,"tbl_df")
  ...
  expect_equal(names(ddd)[1], "dataset_key")
  ...
  expect_equal(names(ii)[1], "dataset_key")
  expect_is(ii,"tbl_df")
