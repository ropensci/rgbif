...
```{r name_lookup1, comment=NA, warning=FALSE, message=FALSE, cache=TRUE}
head(name_lookup(query='Cnaemidophorus', rank="genus", return="data"))
```

### Search for the class mammalia

```{r name_lookup2, comment=NA, warning=FALSE, message=FALSE, cache=TRUE}
name_lookup(class='mammalia')
```

### Look up the species Helianthus annuus

```{r name_lookup3, comment=NA, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r gbifmap2, comment=NA, warning=FALSE, message=FALSE, cache=TRUE}
library(plyr)
