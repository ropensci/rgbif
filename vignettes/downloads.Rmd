...
vignette: >
  %\VignetteIndexEntry{1_downloading}
...
Using the function `gbif_citaiton` we can get citations for our downloads,
...
can get citations for each individual dataset in addition to the entire download.
