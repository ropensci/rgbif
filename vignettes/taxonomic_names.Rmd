...
* P. s<b>y</b>lvestris w/ `r as.character(rgbif::occ_count(c1$usageKey[[1]]))` occurrences - from `r taxon_provider(c1$usageKey[[1]])`
* P. s<b>i</b>lvestris w/ `r as.character(rgbif::occ_count(c1$usageKey[[2]]))` occurrences - from `r taxon_provider(c1$usageKey[[2]])`
...
* M. platyrachis w/ `r rgbif::occ_count(c2$usageKey[[1]])` occurrences - from `r taxon_provider(c2$usageKey[[1]])`
* M. platyr<b>h</b>achis w/ `r rgbif::occ_count(c2$usageKey[[2]])` occurrences - from `r taxon_provider(c2$usageKey[[2]])`
...
* C. circinalis w/ `r rgbif::occ_count(c3$usageKey[[1]])` occurrences - from `r taxon_provider(c3$usageKey[[1]])`
* C. circin<b>n</b>alis w/ `r rgbif::occ_count(c3$usageKey[[2]])` occurrences - from `r taxon_provider(c3$usageKey[[2]])`
...
* I. perrieri w/ `r rgbif::occ_count(c4$usageKey[[1]])` occurrences - from `r taxon_provider(c4$usageKey[[1]])`
* I. perrieri<b>i</b> w/ `r rgbif::occ_count(c4$usageKey[[2]])` occurrences - from `r taxon_provider(c4$usageKey[[2]])`
...
* Wi<b>e</b>sneria w/ `r rgbif::occ_count(c5$usageKey[[1]])` occurrences - from `r taxon_provider(c5$usageKey[[1]])`
* Wisneria w/ `r rgbif::occ_count(c5$usageKey[[2]])` occurrences - from `r taxon_provider(c5$usageKey[[2]])`
