...
vignette: >
  %\VignetteIndexEntry{0_introduction}
...
`rgbif` is an R package to search and retrieve data from the Global Biodiversity Information Facility (GBIF). `rgbif` wraps R code around the [GBIF API][gbifapi] to allow you to talk to GBIF from R.
