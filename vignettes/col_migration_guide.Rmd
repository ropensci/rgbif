...
The **GBIF Backbone Taxonomy** (the old default) uses **numeric** taxon keys such as `5231190` or `2977832`. While still accessible by setting `checklistKey = NULL`, this taxonomy is now out-of-date compared to COL XR.
