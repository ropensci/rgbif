...
> This is an experimental feature, and the implementation may change throughout 2024. The feature is currently only available for preview by invited users. Contact [**helpdesk\@gbif.org**](mailto:helpdesk@gbif.org){.email} to request access. <https://techdocs.gbif.org/en/data-use/api-sql-downloads>
