...
## Downloading using an alternative taxonomy 

GBIF now allows users to download occurrences using an alternative taxonomy. This is done using the `checklistKey` parameter. Currently, you can only choose between two taxonomies:

-   GBIF Backbone Taxonomy (default)
-   Catalogue of Life XR (7ddf754f-d193-4cc9-b351-99906754a03b)

You need to also use the corresponding taxonKey from the alternative taxonomy. You can find these keys using `name_backbone()` with the `checklistKey` parameter.

```r
name_backbone("Calopteryx splendens", checklistKey = "7ddf754f-d193-4cc9-b351-99906754a03b")$usageKey
# "Q2M4"
