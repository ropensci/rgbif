...
**rgbif** now uses the **Catalogue of Life Extended Release (COL XR)** as the default taxonomy, which returns alpha-numeric taxon keys. To use the original **GBIF Backbone Taxonomy** instead, explicitly set `checklistKey = "d7dddbf4-2cf0-4f39-9b2a-bb099caae36c"`.

You need to use the corresponding taxonKey from the chosen taxonomy. You can find these keys using `name_backbone()` with the appropriate `checklistKey` parameter.
