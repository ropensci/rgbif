...
- Retrieve all _Lepus saxatilis_. 
...
Another common download pattern is **long species list downloads**. There is a tutorial about downloading from a long list of species [here](https://docs.ropensci.org/rgbif/reference/downloading_a_long_species_list.html).
...
- `pred("taxonKey", 2436775)` : all _Lepus saxatilis_ records 
